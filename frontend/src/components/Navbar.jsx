      ...
      <div className="max-w-[1400px] mx-auto px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-6">
            <button onClick={(e) => handleNavClick(e, 'home')} className="text-[11px] font-medium text-[#2c4c6e] hover:text-[#1a3a54] tracking-wider border-b-2 border-[#2c4c6e] pb-1">HOME</button>
            <Link to="/services" className="text-[11px] font-medium text-[#666] hover:text-[#2c4c6e] tracking-wider">OUR SERVICES</Link>
            <button onClick={(e) => handleNavClick(e, 'successes')} className="text-[11px] font-medium text-[#666] hover:text-[#2c4c6e] tracking-wider">SUCCESSES</button>
            <button onClick={(e) => handleNavClick(e, 'leadership')} className="text-[11px] font-medium text-[#666] hover:text-[#2c4c6e] tracking-wider">LEADERSHIP</button>
            <button onClick={(e) => handleNavClick(e, 'contact')} className="text-[11px] font-medium text-[#666] hover:text-[#2c4c6e] tracking-wider">CONTACT</button>

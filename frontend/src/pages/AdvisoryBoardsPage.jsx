...
const AdvisoryBoardsPage = () => {
  return (
    <div className="pt-24 min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-light text-slate-800 mb-6 text-center tracking-wide">ADVISORY BOARDS</h1>
...
export default AdvisoryBoardsPage;